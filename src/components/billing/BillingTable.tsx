                    ...
                    <Table>
                        ...
                        <TableBody>
                            {records.map((record) => (
                                <TableRow
                                    key={record.id}
                                    className="group border-b border-border/40 hover:bg-primary/[0.05] transition-all duration-200 cursor-pointer"
                                ...
                                >
                                    ...
                                    <TableCell className="px-5 py-4 text-right w-[120px] whitespace-nowrap">
                                        <span className="text-[13px] font-bold text-destructive tabular-nums">-₹{(record.penaltyDeduction + record.dieselDeduction).toLocaleString()}</span>
                                    </TableCell>
                                    <TableCell className="px-5 py-4 text-right w-[120px] whitespace-nowrap">
