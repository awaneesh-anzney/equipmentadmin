...
import { Plus, Trash2, Clock, Calendar, Fuel, CreditCard, MapPin, Building2, Package } from "lucide-react";
        ...
        <div className="flex flex-col gap-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6">
                <div className="space-y-1.5">
                    ...
                    <Input placeholder="e.g. NEOM Mega City" className="h-10 border-border/50 bg-slate-50/50 focus:bg-white hover:border-primary/40 focus:border-primary transition-all duration-200" />
                </div>
                <div className="space-y-1.5">
                    <Label className="text-[11px] font-semibold uppercase tracking-wider text-muted-foreground/80">Client Name</Label>
                    <Input placeholder="e.g. NEOM Company" className="h-10 border-border/50 bg-slate-50/50 focus:bg-white hover:border-primary/40 focus:border-primary transition-all duration-200" />
                </div>
                <div className="space-y-1.5">
                    <Label className="text-[11px] font-semibold uppercase tracking-wider text-muted-foreground/80">Site Location</Label>
                    <Input placeholder="e.g. Tabuk, Saudi Arabia" className="h-10 border-border/50 bg-slate-50/50 focus:bg-white hover:border-primary/40 focus:border-primary transition-all duration-200" />
                </div>
                <div className="space-y-1.5">
            ...
            <div className="space-y-6 pt-2">
                <div className="flex items-center justify-between border-b border-dashed border-border/60 pb-2">
                    <div className="flex items-center gap-2">
                        ...
                        <h3 className="text-[13px] font-bold text-foreground">Equipment / Vehicles Required</h3>
                    </div>
                    <Button
                        type="button"
                        variant="ghost"
                        ...
                        className="h-8 gap-1.5 text-[11px] font-bold text-foreground hover:bg-primary/10 hover:text-primary transition-colors"
                    >
            ...
            <div className="flex justify-end gap-3 pt-6">
                <Button variant="ghost" className="h-11 px-8 font-bold text-muted-foreground/70 hover:bg-muted transition-all">Discard</Button>
